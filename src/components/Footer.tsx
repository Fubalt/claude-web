...
const iconClass = 'opacity-80 hover:opacity-100 transition-opacity';
const iconColor = '#e8e6e3';
const iconSize = 24;
...
export function Footer() {
  return (
    <footer className="bg-[#181a1b] px-6 py-10 text-center">
      <div className="mx-auto flex max-w-[1512px] flex-col items-center gap-4">
        <div className="flex items-center gap-5">
          ...
          <a href="#" aria-label="TikTok">
            <Music2 size={iconSize} color={iconColor} className={iconClass} />
          </a>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6">
          <a
            ...
            className="text-[14px] text-[#e8e6e3] underline-offset-4 hover:underline"
          >
            hello@bareface.com
          </a>
          <span className="text-[14px] text-[#e8e6e3]">
            +971 50 591 9770
          </span>
          <span className="text-[14px] text-[#e8e6e3]">
        ...
        <p className="text-[13px] text-[#e8e6e3]/70">
